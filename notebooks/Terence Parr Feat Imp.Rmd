...
ggsave('../article/fixed_images/cls_permute_R.svg',
...
ggsave('../article/fixed_images/cls_permute_random_R.svg',
...
ggsave('../article/fixed_images/cls_dflt_R.svg',
       plot = p1, device = 'svg', height = 7, width = 10)

######## with random column ########

p2 <- create_rfplot(rf2, type = 2)
ggsave('../article/fixed_images/cls_dflt_random_R.svg',
       plot = p2, device = 'svg', height = 7, width = 10)
...
ggsave('../article/fixed_images/cls_drop_R.svg',
       plot = p1, device = 'svg', height = 7, width = 10)
...
ggsave('../article/fixed_images/cls_drop_random_R.svg',
       plot = p2, device = 'svg', height = 7, width = 10)
```
